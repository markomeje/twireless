...
use App\Models\{Subscription, Package, Bundle, User};
...
{
    /**
     * Customer subscriptions page view
     */
    public function index()
    {
        return view('customer.subscriptions.index', ['subscriptions' => Subscription::paginate(20)]);
    }
