        ...
        <div class="modal-body">
          <div class="row">
            <div class="form-group col-12">
              ...
              <select class="form-control type custom-select">
            ...
            <div class="form-group col-12">
              <label class="text-muted">Title (for Email only)</label>
              <input type="text" name="duration" class="form-control title" placeholder="Enter title">
